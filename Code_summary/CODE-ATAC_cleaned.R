...
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC81/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC84 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC84/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC86 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC86/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC87 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC87/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC94 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC94/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC96 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC96/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC99 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC99/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC100 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC100/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC101 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC101/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC103 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC103/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC104 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC104/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC106 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC106/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC112 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC112/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC113 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC113/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC114 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC114/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC115 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC115/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC116 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC116/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC119 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC119/peaks.bed",
  col.names = c("chr", "start", "end")
)
peaks.RCC120 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC120/peaks.bed",
  col.names = c("chr", "start", "end")
)
...
md.RCC81 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC81/singlecell.csv",
...
md.RCC84 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC84/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
md.RCC86 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC86/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
md.RCC87 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC87/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
md.RCC94 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC94/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
md.RCC96 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC96/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
md.RCC99 <- read.table(
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC99/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC100/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC101/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC103/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC104/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC106/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC112/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC113/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC114/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC115/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC116/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC119/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
## TODO: Change to relative path for reproducibility
  file = "D:/课题数据/肾透明细胞癌ATAC/RCC120/singlecell.csv",
  stringsAsFactors = FALSE,
  sep = ",",
  header = TRUE,
  row.names = 1
...
## TODO: Change to relative path for reproducibility
pdf('F:/re-restart/全部细胞数据/结果一内容/ATACClusterGVis1.pdf',height = 20,width = 18,onefile = F)
visCluster(object = st.data,
           plot.type = "both",
           column_names_rot = 45,
           show_row_dend = F,
...
## TODO: Change to relative path for reproducibility
pdf('F:/re-restart/全部细胞数据/结果一内容/ATACClusterGVis2.pdf',height = 10,width = 17,onefile = F)
visCluster(object = st.data,
           plot.type = "both",
           column_names_rot = 45,
           show_row_dend = F,
...
## TODO: Change to relative path for reproducibility
save(who2cell_1to3,file="F:/re-restart/全部细胞数据/monocle3数据/肿瘤细胞cds数据-ATAC/新分析数据/Tumor_who1towho3_ATAC.Rdata")
...
C2_tb$cluster<-"C2"
C3_tb$cluster<-"C3"
atac_function<-rbind(C1_tb[1:30,],C2_tb[1:30,],C3_tb[1:30,])
## TODO: Change to relative path for reproducibility
write.xlsx(atac_function,file = "F:/re-restart/全部细胞数据/肿瘤细胞cds数据-ATAC/新分析数据/WHO1-WHO2-WHO3_function.xlsx")
...
atac_function<-rbind(C1_tb[1:30,],C2_tb[1:30,])
## TODO: Change to relative path for reproducibility
write.xlsx(atac_function,file = "F:/re-restart/全部细胞数据/肿瘤细胞cds数据-ATAC/新分析数据/WHO1-WHO2_function.xlsx")
...
## TODO: Change to relative path for reproducibility
write.xlsx(dt_motif,file = "F:/re-restart/全部细胞数据/monocle3结果/新结果/TUMOR/dt_motif.xlsx")
...
## TODO: Change to relative path for reproducibility
  fwrite(list.ccan[[x]]$df, file = paste0("F:/re-restart/全部细胞数据/cicero数据/Tumorwho1-who3ciceroConns.",x,".csv"), row.names = F)
})
## TODO: Change to relative path for reproducibility
save(list.ccan,file = "F:/re-restart/全部细胞数据/cicero数据/Tumorwho1-who3.ccans.Rdata")

ccan <- Get_Ccans(seurat_atac_obj = Tumor_who1towho3_data)
## TODO: Change to relative path for reproducibility
fwrite(ccan$df, file = "F:/re-restart/全部细胞数据/cicero数据/ciceroConns.Tumorwho1-who3.csv", row.names = F)
## TODO: Change to relative path for reproducibility
saveRDS(ccan, file = "F:/re-restart/全部细胞数据/cicero数据/Tumorwho1-who3.ccans.rds")
# Filter Target Genes ----
## TODO: Change to relative path for reproducibility
...
## TODO: Change to relative path for reproducibility
dar_files <- list.files("F:/re-restart/全部细胞数据/cicero数据/tumor", pattern = "ciceroConns.*.csv$", full.names = TRUE)
...
Plot_Cicero_Anno <- function(ident, list.peaks.loc.df) {
  ...
  circos.clear()
## TODO: Change to relative path for reproducibility
  pdf(paste0("F:/re-restart/全部细胞数据/cicero数据/tumor/ccans.annotation.",clusterID,".pdf"), width=10, height=5)
...
## TODO: Change to relative path for reproducibility
conns <- fread(paste0("F:/re-restart/全部细胞数据/cicero数据/tumor/ciceroConns.", cell.type,".csv")) 
...
## TODO: Change to relative path for reproducibility
saveRDS(bg, file = paste0("F:/re-restart/全部细胞数据/cicero数据/tumor/bg.", cell.type,".rds"))
...
## TODO: Change to relative path for reproducibility
write.table(df, file = paste0("F:/re-restart/全部细胞数据/cicero数据/tumor/", cell.type,"_peak_gene_correlation.csv"), sep = ",", quote=FALSE, row.names=F)
## TODO: Change to relative path for reproducibility
saveRDS(df, file = paste0("F:/re-restart/全部细胞数据/cicero数据/tumor/", cell.type,"_peak_gene_correlation.rds"))
...
celltype <- "Tumor"
## TODO: Change to relative path for reproducibility
cCREs <- readRDS(paste0("F:/re-restart/全部细胞数据/cicero数据/", celltype,"_peak_gene_correlation.rds"))
...
## TODO: Change to relative path for reproducibility
load("F:/re-restart/全部细胞数据/cicero数据/之前的/scRNA_new.DEGs.rdata")
...
## TODO: Change to relative path for reproducibility
cCREs <- readRDS("F:/re-restart/全部细胞数据/cicero数据/tumor/Tumor_peak_gene_correlation.rds") 
...
## TODO: Change to relative path for reproducibility
write.xlsx(edge_df.list,file = "F:/re-restart/全部细胞数据/构网数据/Tumor/new/Tumor_C1_edge_df.list.xlsx")
## TODO: Change to relative path for reproducibility
write.xlsx(vertex_df.list,file = "F:/re-restart/全部细胞数据/构网数据/Tumor/new/Tumor_C1_vertex_df.list.xlsx")
## TODO: Change to relative path for reproducibility
write.xlsx(edge_df.list,file = "F:/re-restart/全部细胞数据/构网数据/Tumor/new/Tumor_C2_edge_df.list.xlsx")
## TODO: Change to relative path for reproducibility
write.xlsx(vertex_df.list,file = "F:/re-restart/全部细胞数据/构网数据/Tumor/new/Tumor_C2_vertex_df.list.xlsx")
## TODO: Change to relative path for reproducibility
write.xlsx(edge_df.list,file = "F:/re-restart/全部细胞数据/构网数据/Tumor/new/Tumor_C3_edge_df.list.xlsx")
## TODO: Change to relative path for reproducibility
write.xlsx(vertex_df.list,file = "F:/re-restart/全部细胞数据/构网数据/Tumor/new/Tumor_C3_vertex_df.list.xlsx")
...
atac_function<-rbind(C1_tb[1:30,],C2_tb[1:30,])
## TODO: Change to relative path for reproducibility
write.xlsx(atac_function,file = "F:/re-restart/全部细胞数据/T细胞亚型cds数据-atac/ALLnaive-ex_function.xlsx")
...
Plot_Cicero_Anno <- function(ident, list.peaks.loc.df) {
  ...
  circos.clear()
## TODO: Change to relative path for reproducibility
  pdf(paste0("F:/re-restart/全部细胞数据/cicero数据/ccans.annotation.",clusterID,".pdf"), width=10, height=5)
  par(mar=c(0.5,0.5,0.5,0.5))
  circos.par(gap.after = 5)
  chordDiagram(toplot,
               grid.col = grid.col,
...
peak2.anno <- list.peak2.Anno[[cell.type]]@anno
## TODO: Change to relative path for reproducibility
conns <- fread(paste0("F:/re-restart/全部细胞数据/cicero数据/ciceroConns.allCD8T.csv")) 
conns <- conns %>% dplyr::filter(coaccess > 0.2) 
conns <- conns %>% mutate(peak1_type = peak1.anno$annotation, peak1_distanceToTSS = peak1.anno$distanceToTSS, peak1_nearestGene = peak1.anno$SYMBOL,
                          peak2_type = peak2.anno$annotation, peak2_distanceToTSS = peak2.anno$distanceToTSS, peak2_nearestGene = peak2.anno$SYMBOL)
bg <- na.omit(unique(c(conns$peak1_nearestGene, conns$peak2_nearestGene)))
...
## TODO: Change to relative path for reproducibility
write.table(DF, file = paste0("F:/re-restart/全部细胞数据/cicero数据/", cell.type,"_peak_gene_correlation.csv"), sep = ",", quote=FALSE, row.names=F)
## TODO: Change to relative path for reproducibility
saveRDS(DF, file = paste0("F:/re-restart/全部细胞数据/cicero数据/", cell.type,"_peak_gene_correlation.rds"))
...
## TODO: Change to relative path for reproducibility
scRNA.DEGs <- readRDS("F:/re-restart/全部细胞数据/cicero数据/cellType.sig.pos.DEGs.rds")
...
## TODO: Change to relative path for reproducibility
cCREs <- readRDS("F:/re-restart/全部细胞数据/cicero数据/allCD8T_peak_gene_correlation.rds")
...
## TODO: Change to relative path for reproducibility
write.xlsx(edge_df.list,file = "F:/re-restart/全部细胞数据/构网数据/CD8T/new/CD8T_C2_edge_df.list.xlsx")
## TODO: Change to relative path for reproducibility
write.xlsx(vertex_df.list,file = "F:/re-restart/全部细胞数据/构网数据/CD8T/new/CD8T_C2_vertex_df.list.xlsx")

TF.motifs_c1<-dt_motif$motif.name[11:20]
## TODO: Change to relative path for reproducibility
write.xlsx(edge_df.list,file = "F:/re-restart/全部细胞数据/构网数据/CD8T/new/CD8T_C1_edge_df.list.xlsx")
## TODO: Change to relative path for reproducibility
write.xlsx(vertex_df.list,file = "F:/re-restart/全部细胞数据/构网数据/CD8T/new/CD8T_C1_vertex_df.list.xlsx")
...
## TODO: Change to relative path for reproducibility
write.xlsx(atac_function,file = "F:/re-restart/全部细胞数据/monocle3数据/单核-巨噬cds数据-atac/11.16后新的/mono_m1_function.xlsx")
...
atac_function<-rbind(C1_tb[1:10,],C2_tb[1:10,])
## TODO: Change to relative path for reproducibility
write.xlsx(atac_function,file = "F:/re-restart/全部细胞数据/monocle3数据/单核-巨噬cds数据-atac/11.16后新的/mono_m2_function.xlsx")
...
dt_motif<-rbind(dt_motif1,dt_motif2)
## TODO: Change to relative path for reproducibility
write.xlsx(dt_motif,file = "F:/re-restart/全部细胞数据/monocle3结果/新结果/ATAC/mono-macro/11.19后新/dt_motif.xlsx")
...
lapply(names(list.ccan), function(x) {
## TODO: Change to relative path for reproducibility
  fwrite(list.ccan[[x]]$df, file = paste0("F:/re-restart/全部细胞数据/cicero数据/mono_m1/Mono_M1_ciceroConns.",x,".csv"), row.names = F)
})
## TODO: Change to relative path for reproducibility
save(list.ccan,file = "F:/re-restart/全部细胞数据/cicero数据/mono_m1/Mono_M1.ccans.Rdata")

ccan <- Get_Ccans(seurat_atac_obj = Mono_M1)
## TODO: Change to relative path for reproducibility
fwrite(ccan$df, file = "F:/re-restart/全部细胞数据/cicero数据/mono_m1/ciceroConns.Mono_M1.csv", row.names = F)
## TODO: Change to relative path for reproducibility
saveRDS(ccan, file = "F:/re-restart/全部细胞数据/cicero数据/mono_m1/Mono_M1.ccans.rds")
# Filter Target Genes ----
## TODO: Change to relative path for reproducibility
source(file = "F:/RenalTumor-main/Functions/Plot_colorPaletters.R")
## TODO: Change to relative path for reproducibility
source(file = "F:/RenalTumor-main/ATAC/Functions/user.CoveragePlot.R")
## TODO: Change to relative path for reproducibility
dar_files <- list.files("F:/re-restart/全部细胞数据/cicero数据/mono_m1", pattern = "ciceroConns.*.csv$", full.names = TRUE)
idents <- gsub(".*ciceroConns.", "", dar_files)
idents <- gsub(".csv", "", idents)
list.dar <- lapply(dar_files, function(file_path) {
  fread(file_path) %>%
...
Plot_Cicero_Anno <- function(ident, list.peaks.loc.df) {
  ...
  circos.clear()
## TODO: Change to relative path for reproducibility
  pdf(paste0("F:/re-restart/全部细胞数据/cicero数据/mono_m1/ccans.annotation.",clusterID,".pdf"), width=10, height=5)
  par(mar=c(0.5,0.5,0.5,0.5))
  circos.par(gap.after = 5)
  chordDiagram(toplot,
               grid.col = grid.col,
...
peak2.anno <- list.peak2.Anno[[cell.type]]@anno
## TODO: Change to relative path for reproducibility
conns <- fread(paste0("F:/re-restart/全部细胞数据/cicero数据/mono_m1/ciceroConns.", cell.type,".csv")) 
conns <- conns %>% dplyr::filter(coaccess > 0.2)
conns <- conns %>% mutate(peak1_type = peak1.anno$annotation, peak1_distanceToTSS = peak1.anno$distanceToTSS, peak1_nearestGene = peak1.anno$SYMBOL,
                          peak2_type = peak2.anno$annotation, peak2_distanceToTSS = peak2.anno$distanceToTSS, peak2_nearestGene = peak2.anno$SYMBOL)
bg <- na.omit(unique(c(conns$peak1_nearestGene, conns$peak2_nearestGene))) 
## TODO: Change to relative path for reproducibility
saveRDS(bg, file = paste0("F:/re-restart/全部细胞数据/cicero数据/mono_m1/bg.", cell.type,".rds"))
...
## TODO: Change to relative path for reproducibility
write.table(df, file = paste0("F:/re-restart/全部细胞数据/cicero数据/mono_m1/", cell.type,"_peak_gene_correlation.csv"), sep = ",", quote=FALSE, row.names=F)
## TODO: Change to relative path for reproducibility
saveRDS(df, file = paste0("F:/re-restart/全部细胞数据/cicero数据/mono_m1/", cell.type,"_peak_gene_correlation.rds"))
# Identify Target Genes Corresponding to TFs ----

cell.type <- c("Mono_m1")
## TODO: Change to relative path for reproducibility
cCREs <- readRDS(paste0("F:/re-restart/全部细胞数据/cicero数据/mono_m1/", cell.type,"_peak_gene_correlation.rds"))
cCREs <- cCREs %>% subset(distance_bp/1000>=10 & peak2_type != 'Promoter')
cCREs$target_gene <- cCREs$peak1_nearestGene
cCREs$peak_gene <- paste0(cCREs$Peak2, '_', cCREs$peak1_nearestGene)
cCREs$Peak1 <- gsub("_", "-", cCREs$Peak1)
...
## TODO: Change to relative path for reproducibility
cCREs <- readRDS("F:/re-restart/全部细胞数据/cicero数据/mono_m1/Mono_M1_peak_gene_correlation.rds")
...
## TODO: Change to relative path for reproducibility
write.xlsx(edge_df.list,file = "F:/re-restart/全部细胞数据/构网数据/mono_m1/new/mono_m1_C1_edge_df.list.xlsx")
## TODO: Change to relative path for reproducibility
write.xlsx(vertex_df.list,file = "F:/re-restart/全部细胞数据/构网数据/mono_m1/new/mono_m1_C1_vertex_df.list.xlsx")

interest.TFs<-c("SPI1","RELA","REL","ATF2","EGR1","EGR2","SPIB","TFAP2A","MZF1","TFAP2C")

## TODO: Change to relative path for reproducibility
write.xlsx(edge_df.list,file = "F:/re-restart/全部细胞数据/构网数据/mono_m1/new/mono_m1_C2_edge_df.list.xlsx")
## TODO: Change to relative path for reproducibility
write.xlsx(vertex_df.list,file = "F:/re-restart/全部细胞数据/构网数据/mono_m1/new/mono_m1_C2_vertex_df.list.xlsx")
...
dt_motif<-rbind(dt_motif1,dt_motif2)
## TODO: Change to relative path for reproducibility
write.xlsx(dt_motif,file = "F:/re-restart/全部细胞数据/monocle3结果/新结果/ATAC/mono-macro/11.19后新/dt_motif_mono_m2.xlsx")
...
lapply(names(list.ccan), function(x) {
## TODO: Change to relative path for reproducibility
  fwrite(list.ccan[[x]]$df, file = paste0("F:/re-restart/全部细胞数据/cicero数据/mono_m2/Mono_M2_ciceroConns.",x,".csv"), row.names = F)
})
## TODO: Change to relative path for reproducibility
save(list.ccan,file = "F:/re-restart/全部细胞数据/cicero数据/mono_m2/Mono_M2.ccans.Rdata")

ccan <- Get_Ccans(seurat_atac_obj = Mono_M2)
## TODO: Change to relative path for reproducibility
fwrite(ccan$df, file = "F:/re-restart/全部细胞数据/cicero数据/mono_m2/ciceroConns.Mono_M2.csv", row.names = F)
## TODO: Change to relative path for reproducibility
saveRDS(ccan, file = "F:/re-restart/全部细胞数据/cicero数据/mono_m2/Mono_M2.ccans.rds")
# Filter Target Genes ----
## TODO: Change to relative path for reproducibility
source(file = "F:/RenalTumor-main/Functions/Plot_colorPaletters.R")
## TODO: Change to relative path for reproducibility
source(file = "F:/RenalTumor-main/ATAC/Functions/user.CoveragePlot.R")
## TODO: Change to relative path for reproducibility
dar_files <- list.files("F:/re-restart/全部细胞数据/cicero数据/mono_m2", pattern = "ciceroConns.*.csv$", full.names = TRUE)
idents <- gsub(".*ciceroConns.", "", dar_files)
idents <- gsub(".csv", "", idents)
list.dar <- lapply(dar_files, function(file_path) {
  fread(file_path) %>%
...
Plot_Cicero_Anno <- function(ident, list.peaks.loc.df) {
  ...
  circos.clear()
## TODO: Change to relative path for reproducibility
  pdf(paste0("F:/re-restart/全部细胞数据/cicero数据/mono_m2/ccans.annotation.",clusterID,".pdf"), width=10, height=5)
  par(mar=c(0.5,0.5,0.5,0.5))
  circos.par(gap.after = 5)
  chordDiagram(toplot,
               grid.col = grid.col,
...
peak2.anno <- list.peak2.Anno[[cell.type]]@anno
## TODO: Change to relative path for reproducibility
conns <- fread(paste0("F:/re-restart/全部细胞数据/cicero数据/mono_m2/ciceroConns.", cell.type,".csv")) 
conns <- conns %>% dplyr::filter(coaccess > 0.2)
conns <- conns %>% mutate(peak1_type = peak1.anno$annotation, peak1_distanceToTSS = peak1.anno$distanceToTSS, peak1_nearestGene = peak1.anno$SYMBOL,
                          peak2_type = peak2.anno$annotation, peak2_distanceToTSS = peak2.anno$distanceToTSS, peak2_nearestGene = peak2.anno$SYMBOL)
bg <- na.omit(unique(c(conns$peak1_nearestGene, conns$peak2_nearestGene))) 
## TODO: Change to relative path for reproducibility
saveRDS(bg, file = paste0("F:/re-restart/全部细胞数据/cicero数据/mono_m2/bg.", cell.type,".rds"))
...
## TODO: Change to relative path for reproducibility
write.table(df, file = paste0("F:/re-restart/全部细胞数据/cicero数据/mono_m2/", cell.type,"_peak_gene_correlation.csv"), sep = ",", quote=FALSE, row.names=F)
## TODO: Change to relative path for reproducibility
saveRDS(df, file = paste0("F:/re-restart/全部细胞数据/cicero数据/mono_m2/", cell.type,"_peak_gene_correlation.rds"))
# Identify Target Genes Corresponding to TFs ----

cell.type <- c("Mono_m2")
## TODO: Change to relative path for reproducibility
cCREs <- readRDS(paste0("F:/re-restart/全部细胞数据/cicero数据/mono_m2/", cell.type,"_peak_gene_correlation.rds"))
cCREs <- cCREs %>% subset(distance_bp/1000>=10 & peak2_type != 'Promoter')
cCREs$target_gene <- cCREs$peak1_nearestGene
cCREs$peak_gene <- paste0(cCREs$Peak2, '_', cCREs$peak1_nearestGene)
cCREs$Peak1 <- gsub("_", "-", cCREs$Peak1)
...
## TODO: Change to relative path for reproducibility
dt_motif<-read.xlsx("F:/re-restart/全部细胞数据/monocle3结果/新结果/ATAC/mono-macro/11.19后新/dt_motif_mono_m2.xlsx")
...
## TODO: Change to relative path for reproducibility
cCREs <- readRDS("F:/re-restart/全部细胞数据/cicero数据/mono_m2/Mono_M2_peak_gene_correlation.rds")
...
## TODO: Change to relative path for reproducibility
write.xlsx(edge_df.list,file = "F:/re-restart/全部细胞数据/构网数据/mono_m2/new/mono_m2_C2_edge_df.list.xlsx")
## TODO: Change to relative path for reproducibility
write.xlsx(vertex_df.list,file = "F:/re-restart/全部细胞数据/构网数据/mono_m2/new/mono_m2_C2_vertex_df.list.xlsx")

interest.TFs<- c("CREB1","KLF4","KLF2","NR4A2","CEBPD","JUN","RARA::RXRG","SP3","RARA","RXRB")
## TODO: Change to relative path for reproducibility
write.xlsx(edge_df.list,file ="F:/re-restart/全部细胞数据/构网数据/mono_m2/new/mono_m2_C1_edge_df.list.xlsx")
## TODO: Change to relative path for reproducibility
write.xlsx(vertex_df.list,file ="F:/re-restart/全部细胞数据/构网数据/mono_m2/new/mono_m2_C1_vertex_df.list.xlsx")
