...
setwd("D:/课题数据/肾透明细胞癌scRNA")
## TODO: Change to relative path for reproducibility
RCC81 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC81")
## TODO: Change to relative path for reproducibility
RCC84 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC84")
## TODO: Change to relative path for reproducibility
RCC86 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC86")
## TODO: Change to relative path for reproducibility
RCC87 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC87")
## TODO: Change to relative path for reproducibility
RCC94 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC94")
## TODO: Change to relative path for reproducibility
RCC96 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC96")
## TODO: Change to relative path for reproducibility
RCC99 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC99")
## TODO: Change to relative path for reproducibility
RCC100 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC100")
## TODO: Change to relative path for reproducibility
RCC101 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC101")
## TODO: Change to relative path for reproducibility
RCC103 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC103")
## TODO: Change to relative path for reproducibility
RCC104 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC104")
## TODO: Change to relative path for reproducibility
RCC106 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC106")
## TODO: Change to relative path for reproducibility
RCC112 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC112")
## TODO: Change to relative path for reproducibility
RCC113 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC113")
## TODO: Change to relative path for reproducibility
RCC114 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC114")
## TODO: Change to relative path for reproducibility
RCC115 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC115")
## TODO: Change to relative path for reproducibility
RCC116 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC116")
## TODO: Change to relative path for reproducibility
RCC119 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC119")
## TODO: Change to relative path for reproducibility
RCC120 <- Read10X(data.dir ="D:/课题数据/肾透明细胞癌scRNA/RCC120")
...
## TODO: Change to relative path for reproducibility
infercnv_obj = CreateInfercnvObject(raw_counts_matrix="D:/课题数据/infercnv/expFile.txt",
## TODO: Change to relative path for reproducibility
                                    annotations_file="D:/课题数据/infercnv/metaFiles.txt",
                                    delim="\t",
## TODO: Change to relative path for reproducibility
                                    gene_order_file= "D:/课题数据/infercnv/geneFile.txt",
...
## TODO: Change to relative path for reproducibility
load("D:/课题数据/infercnv/infercnv_obj_over.Rdata")
...
gn <- rownames(expr)
## TODO: Change to relative path for reproducibility
geneFile <- read.table("D:/课题数据/infercnv/geneFile.txt",header = F,sep = "\t",stringsAsFactors = F)
...
## TODO: Change to relative path for reproducibility
kmeans_df_s <- read.table("D:/课题数据/infercnv/kmeans_df_s.txt",header = T,sep = "\t",stringsAsFactors = F)
...
## TODO: Change to relative path for reproducibility
kmeans_df_s<-read.table("D:/课题数据/infercnv/kmeans_df_s.txt",sep = '\t',header = T)
...
## TODO: Change to relative path for reproducibility
write.xlsx(RNA_function,file = "E:/re-restart/全部细胞数据/肿瘤细胞cds数据-RNA/新分析数据/WHO2-WHO3_function.xlsx")
...
## TODO: Change to relative path for reproducibility
write.xlsx(RNA_function,file = "E:/re-restart/全部细胞数据/肿瘤细胞cds数据-RNA/新分析数据/WHO1-WHO2-WHO3_function.xlsx")
...
## TODO: Change to relative path for reproducibility
c1_ppi<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/TUMOR/new/C1-PPI.xlsx")
c1_ppi_sub<-subset(c1_ppi,`#node1` %in% c1genes)
## TODO: Change to relative path for reproducibility
Tumor_C2_vertex_df<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/Tumor/new/Tumor_C1_vertex_df.list.xlsx")
C1_TG<-subset(Tumor_C1_vertex_df,size != 10)
c1_ppi_sub<-subset(c1_ppi_sub,node2 %in% C1_TG$name)
## TODO: Change to relative path for reproducibility
write.xlsx(c1_ppi_sub,file = "F:/re-restart/全部细胞数据/构网数据/TUMOR/new/c1_ppi_sub.xlsx")
## TODO: Change to relative path for reproducibility
c2_ppi<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/TUMOR/new/C2-PPI.xlsx")
c2_ppi_sub<-subset(c2_ppi,`#node1` %in% c2genes)
## TODO: Change to relative path for reproducibility
Tumor_C2_vertex_df<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/Tumor/new/Tumor_C2_vertex_df.list.xlsx")
C2_TG<-subset(Tumor_C2_vertex_df,size != 10)
c2_ppi_sub<-subset(c2_ppi_sub,node2 %in% C2_TG$name)
## TODO: Change to relative path for reproducibility
write.xlsx(c2_ppi_sub,file = "F:/re-restart/全部细胞数据/构网数据/TUMOR/new/c2_ppi_sub.xlsx")
## TODO: Change to relative path for reproducibility
c3_ppi<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/TUMOR/new/C3-PPI.xlsx")
c3_ppi_sub<-subset(c3_ppi,`#node1` %in% c3genes)
## TODO: Change to relative path for reproducibility
Tumor_C3_vertex_df<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/Tumor/new/Tumor_C3_vertex_df.list.xlsx")
C3_TG<-subset(Tumor_C3_vertex_df,size != 10)
c3_ppi_sub<-subset(c3_ppi_sub,node2 %in% C3_TG$name)
## TODO: Change to relative path for reproducibility
write.xlsx(c3_ppi_sub,file = "F:/re-restart/全部细胞数据/构网数据/TUMOR/new/c3_ppi_sub.xlsx")
...
RNA_function<-rbind(C1.go@result[1:10,],C2.go@result[1:10,],C3.go@result[1:10,])
## TODO: Change to relative path for reproducibility
write.xlsx(RNA_function,file = "E:/re-restart/全部细胞数据/monocle3数据/T细胞亚型cds数据-rna/naive-ex-E-P_tb.xlsx")
# Extract Genes with Moran's I > 0.25 ----
modulated_genes <- CD8Trna_graph_test_res
genes <- row.names(subset(modulated_genes, q_value < 0.01 & morans_I > 0.25))
CD8T_htkm <- htkm
...
# Read and Output PPI Network (score > 0.65) ----
## TODO: Change to relative path for reproducibility
c1_ppi<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/CD8T/new/C1-PPI.xlsx")
c1_ppi_sub<-subset(c1_ppi,`#node1` %in% c1genes)
## TODO: Change to relative path for reproducibility
CD8T_C1_vertex_df<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/CD8T/new/CD8T_C1_vertex_df.list.xlsx")
C1_TG<-subset(CD8T_C1_vertex_df,size != 10)
c1_ppi_sub<-subset(c1_ppi_sub,node2 %in% C1_TG$name)
## TODO: Change to relative path for reproducibility
write.xlsx(c1_ppi_sub,file = "F:/re-restart/全部细胞数据/构网数据/CD8T/new/c1_ppi_sub.xlsx")
## TODO: Change to relative path for reproducibility
c2_ppi<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/CD8T/new/C2-PPI.xlsx")
c2_ppi_sub<-subset(c2_ppi,`#node1` %in% c2genes)
## TODO: Change to relative path for reproducibility
CD8T_C1_vertex_df<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/CD8T/new/CD8T_C2_vertex_df.list.xlsx")
C2_TG<-subset(CD8T_C1_vertex_df,size != 10)
c2_ppi_sub<-subset(c2_ppi_sub,node2 %in% C2_TG$name)
## TODO: Change to relative path for reproducibility
write.xlsx(c2_ppi_sub,file = "F:/re-restart/全部细胞数据/构网数据/CD8T/new/c2_ppi_sub.xlsx")
...
## TODO: Change to relative path for reproducibility
CD8T_C2_vertex_df<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/CD8T/new/CD8T_C2_vertex_df.list.xlsx")
...
RNA_function<-rbind(C1.go@result[1:10,],C2.go@result[1:10,])
## TODO: Change to relative path for reproducibility
write.xlsx(RNA_function,file = "E:/re-restart/全部细胞数据/monocle3数据/单核-巨噬cds数据-rna/mono_M1_tb.xlsx")
...
RNA_function<-rbind(C1.go@result[1:10,],C2.go@result[1:10,])
## TODO: Change to relative path for reproducibility
write.xlsx(RNA_function,file = "E:/re-restart/全部细胞数据/monocle3数据/单核-巨噬cds数据-rna/mono_M2_tb.xlsx")
...
## TODO: Change to relative path for reproducibility
c1_ppi<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/mono_m1/new/C1-PPI.xlsx")
c1_ppi_sub<-subset(c1_ppi,`#node1` %in% c1genes)
## TODO: Change to relative path for reproducibility
mono_m1_C1_vertex_df<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/mono_m1/new/mono_m1_C1_vertex_df.list.xlsx")
C1_TG<-subset(mono_m1_C1_vertex_df,size != 10)
c1_ppi_sub<-subset(c1_ppi_sub,node2 %in% C1_TG$name)
## TODO: Change to relative path for reproducibility
write.xlsx(c1_ppi_sub,file = "F:/re-restart/全部细胞数据/构网数据/mono_m1/new/c1_ppi_sub.xlsx")
## TODO: Change to relative path for reproducibility
c2_ppi<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/mono_m1/new/C2-PPI.xlsx")
c2_ppi_sub<-subset(c2_ppi,`#node1` %in% c2genes)
## TODO: Change to relative path for reproducibility
mono_m1_C2_vertex_df<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/mono_m1/new/mono_m1_C2_vertex_df.list.xlsx")
C2_TG<-subset(mono_m1_C2_vertex_df,size != 10)
c2_ppi_sub<-subset(c2_ppi_sub,node2 %in% C2_TG$name)
## TODO: Change to relative path for reproducibility
write.xlsx(c2_ppi_sub,file = "F:/re-restart/全部细胞数据/构网数据/mono_m1/new/c2_ppi_sub.xlsx")
# Output M2 PPI Network (Target -> Pseudotime) ----
## TODO: Change to relative path for reproducibility
c1_ppi<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/mono_m2/new/C1-PPI.xlsx")
c1_ppi_sub<-subset(c1_ppi,`#node1` %in% c1genes)
## TODO: Change to relative path for reproducibility
mono_m2_C1_vertex_df<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/mono_m2/new/mono_m2_C1_vertex_df.list.xlsx")
C1_TG<-subset(mono_m2_C1_vertex_df,size != 10)
c1_ppi_sub<-subset(c1_ppi_sub,node2 %in% C1_TG$name)
## TODO: Change to relative path for reproducibility
write.xlsx(c1_ppi_sub,file = "F:/re-restart/全部细胞数据/构网数据/mono_m2/new/c1_ppi_sub.xlsx")
## TODO: Change to relative path for reproducibility
c2_ppi<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/mono_m2/new/C2-PPI.xlsx")
c2_ppi_sub<-subset(c2_ppi,`#node1` %in% c2genes)
## TODO: Change to relative path for reproducibility
mono_m2_C2_vertex_df<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/mono_m2/new/mono_m2_C2_vertex_df.list.xlsx")
C2_TG<-subset(mono_m2_C2_vertex_df,size != 10)
c2_ppi_sub<-subset(c2_ppi_sub,node2 %in% C2_TG$name)
## TODO: Change to relative path for reproducibility
write.xlsx(c2_ppi_sub,file = "F:/re-restart/全部细胞数据/构网数据/mono_m2/new/c2_ppi_sub.xlsx")
...
if(organism == "human"){
  ...
  lr_network_all = 
    readRDS(
## TODO: Change to relative path for reproducibility
      "F:/re-restart/全部细胞数据/结果五内容/multi/lr_network_human_allInfo_30112033.rds"
    ) %>% 
    mutate(
...
## TODO: Change to relative path for reproducibility
    "F:/re-restart/全部细胞数据/结果五内容/multi/ligand_target_matrix_nsga2r_final.rds"
  )
...
## TODO: Change to relative path for reproducibility
path = "E:/re-restart/全部细胞数据/结果五内容/multi/"
...
gc()
## TODO: Change to relative path for reproducibility
df <- data.table::fread("E:/invalid_data/ccRCC_exp_log_quantile_normalized.txt",data.table = F) %>% 
  dplyr::select(-c(1:2))
names(df)[1] <- "acc"
df[1:4,1:4]
...
## TODO: Change to relative path for reproducibility
cli <- readxl::read_xlsx("E:/invalid_data/41588_2013_BFng2699_MOESM35_ESM.xlsx",skip = 1)
cli <- cli %>% 
...
## TODO: Change to relative path for reproducibility
write.csv(eset1,"E:/invalid_data/result/emtab1980_eset.csv",row.names = F,quote = F)
## TODO: Change to relative path for reproducibility
write.csv(cli1,file = "E:/invalid_data/result/emtab1980_pdata.csv",row.names = F, quote = F)
## TODO: Change to relative path for reproducibility
write.csv(cli1,file = "E:/invalid_data/result/emtab1980_pdata_final.csv",row.names = F, quote = F)
for (i in 1:19148) {
...
## TODO: Change to relative path for reproducibility
write.csv(cli1,file = "E:/invalid_data/result/MATB_1980_valid_data.csv",row.names = F, quote = F)

# Prepare TCGA Survival Data ----

## TODO: Change to relative path for reproducibility
json <- jsonlite::fromJSON("E:/survival_data/metadata.cart.2024-10-10.json")
...
## TODO: Change to relative path for reproducibility
clinical <- read_tsv('E:/survival_data/clinical_data/clinical.tsv')
...
## TODO: Change to relative path for reproducibility
metafile="E:/survival_data/metadata.cart.2024-10-10.json"
## TODO: Change to relative path for reproducibility
gdcfliename="E:/survival_data/gdc_download_20241010_022632.240262"
## TODO: Change to relative path for reproducibility
path1="E:/survival_data/gdc_download_20241010_022632.240262/"
...
## TODO: Change to relative path for reproducibility
matrix <- read.csv("E:/result5/新建文件夹/ccRCC_clinical_2.csv")
## TODO: Change to relative path for reproducibility
clin <- fread("E:/survival_data/clinical_data/clinical.tsv",data.table = F)
clin_time <- clin %>% 
...
## TODO: Change to relative path for reproducibility
write.csv(merge, file = "E:/result5/新建文件夹/ccRCC_clinical_3.csv", row.names = FALSE,quote = F)
## TODO: Change to relative path for reproducibility
merge <- read.csv("E:/result5/新建文件夹/ccRCC_clinical_3.csv")
# Read Network Hub Nodes ----
## TODO: Change to relative path for reproducibility
tumor_c1hub<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/TUMOR/new/0.65/c1hub.xlsx")
## TODO: Change to relative path for reproducibility
tumor_c2hub<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/TUMOR/new/0.65/c2hub.xlsx")
...
## TODO: Change to relative path for reproducibility
CD8T_c1hub<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/CD8T/new/0.65/c1hub.xlsx")
## TODO: Change to relative path for reproducibility
CD8T_c2hub<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/CD8T/new/0.65/c2hub.xlsx")
...
## TODO: Change to relative path for reproducibility
monom1_c1hub<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/mono_m1/new/0.65/c1hub.xlsx")
## TODO: Change to relative path for reproducibility
monom1_c2hub<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/mono_m1/new/0.65/c2hub.xlsx")
## TODO: Change to relative path for reproducibility
monom2_c1hub<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/mono_m2/new/0.65/c1hub.xlsx")
## TODO: Change to relative path for reproducibility
monom2_c2hub<-read.xlsx("F:/re-restart/全部细胞数据/构网数据/mono_m2/new/0.65/c2hub.xlsx")
...
## TODO: Change to relative path for reproducibility
merge <- read.csv("F:/result5/新建文件夹/ccRCC_clinical_3.csv")
...
## TODO: Change to relative path for reproducibility
save(res_all,file = "F:/re-restart/全部细胞数据/结果六内容/0.65hubgene_result.Rdata")
# Visualize Results ----
...
(12.3)
## TODO: Change to relative path for reproducibility
collected_sig_table<-read.xlsx("F:/re-restart/全部细胞数据/结果七内容/已有模型2.xlsx")
